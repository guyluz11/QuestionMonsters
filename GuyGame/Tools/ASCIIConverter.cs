...
public class ASCIIConverter
{
    ...
    // My Example 
    public void saveImageAsHtmlPage()    // take the cat picture and save ascii html page in C:\Users\Public\Downloads\WriteText.html
    {
                    
        string musicFileLocation = Path.GetDirectoryName(Assembly.GetEntryAssembly().Location) + @"\..\..\cat.jpg" ;    // Location of the file in the specific computer

        Image newImage = Image.FromFile(musicFileLocation);
            
        var imageAsString = ASCIIConverter.ImageToText(newImage, "gz");

            
        System.IO.File.WriteAllText(@"C:\Users\Public\Downloads\WriteText.html", "<!DOCTYPE html><html><head> " +imageAsString + "</body></html>");
    ...
    public static string ImageToText(Image img, string strInputChar)
    {
        Bitmap bmp = null;
    ...
    /// <param name="strInputChar">The character to use in the drawing.</param>
    /// <returns>HTML formatted text</returns>
    public static string GrayscaleImageToText(Image img, string strInputChar)
    {
        StringBuilder html = new StringBuilder();
        Bitmap bmp = null;
